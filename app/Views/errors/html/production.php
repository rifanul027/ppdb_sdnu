...
<head>
    ...
    <title>Terjadi Kesalahan - PPDB SDNU Pemanahan</title>
    <meta name="description" content="Terjadi kesalahan pada sistem - PPDB SD Nahdlatul Ulama Pemanahan">
    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8 text-center">
            ...
            <div class="animate-slide-up">
                <!-- Error Icon -->
                <div class="mb-8">
                    <div class="mx-auto w-24 h-24 bg-red-100 rounded-full flex items-center justify-center mb-6 animate-pulse-slow">
                ...
                <!-- Error Message -->
                <div class="mb-8">
                    <h2 class="text-3xl font-bold text-gray-900 mb-4">Terjadi Kesalahan</h2>
                    <p class="text-lg text-gray-600 mb-6">
                        Mohon maaf, terjadi kesalahan pada sistem kami. 
                ...
                <div class="mt-12 pt-8 border-t border-gray-200">
                    <p class="text-sm text-gray-500 mb-4">Butuh bantuan teknis? Hubungi kami:</p>
                    <div class="flex justify-center space-x-6">
                        <a href="https://wa.me/6282223008689?text=Saya mengalami kesalahan pada website PPDB SDNU" target="_blank" 
                        ...
                        <a href="mailto:admin@sdnuperamanahan.com?subject=Error Report" 
                           class="text-nu-green hover:text-nu-dark transition-colors">
