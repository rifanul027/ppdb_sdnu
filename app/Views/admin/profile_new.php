    ...
    <div class="card-body">
        <div style="max-height: 300px; overflow-y: auto;">
            <div style="display: flex; align-items: center; padding: 1rem; border-bottom: 1px solid #e5e7eb;">
                <div style="width: 40px; height: 40px; background-color: #1B5E20; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 1rem;">
                    <i class="fas fa-sign-in-alt" style="color: white; font-size: 0.875rem;"></i>
                </div>
                <div style="flex: 1;">
                    <div style="font-weight: 500; font-size: 0.875rem;">Login ke dashboard</div>
                    <div style="color: #6b7280; font-size: 0.75rem;"><?= date('d M Y, H:i') ?></div>
                </div>
            </div>
            
            <div style="display: flex; align-items: center; padding: 1rem; border-bottom: 1px solid #e5e7eb;">
                <div style="width: 40px; height: 40px; background-color: #059669; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 1rem;">
                    <i class="fas fa-user-edit" style="color: white; font-size: 0.875rem;"></i>
                </div>
                <div style="flex: 1;">
                    <div style="font-weight: 500; font-size: 0.875rem;">Profile diperbarui</div>
                    <div style="color: #6b7280; font-size: 0.75rem;">2 hari yang lalu</div>
                </div>
            </div>
            
            <div style="display: flex; align-items: center; padding: 1rem;">
                <div style="width: 40px; height: 40px; background-color: #3b82f6; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 1rem;">
                    <i class="fas fa-cog" style="color: white; font-size: 0.875rem;"></i>
                </div>
                <div style="flex: 1;">
                    <div style="font-weight: 500; font-size: 0.875rem;">Settings diupdate</div>
                    <div style="color: #6b7280; font-size: 0.75rem;">1 minggu yang lalu</div>
                </div>
            </div>
        </div>
    </div>
